...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            // Note: fastapi OAuth2PasswordRequestForm expects email in the username field
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-2">
                                <label className="block text-xs font-semibold text-amber-400 uppercase tracking-wider">Password</label>
                            </div>
                            <input
                                type="password"
                                placeholder="••••••••"
